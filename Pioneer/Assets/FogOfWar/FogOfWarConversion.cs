...
namespace FoW
{
    ...
    public static class FogOfWarConversion
    {
        ...
        public static Vector3 FogToWorld(Vector3 fpos, FogOfWarPlane plane, Vector2 offset, Vector2Int resolution, float size)
        {
            return FogPlaneToWorld(FogToWorld(fpos, offset, resolution, size), plane);
        }
