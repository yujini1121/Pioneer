...
// ëª¨ë“  ê²Œì„ Ui???¬ê¸°???´ê²°?©ë‹ˆ??
// ?¸ë???ì¡°ì‘?€ ?´ë‹¹ ì»´í¬?ŒíŠ¸ë¥?ê²½ìœ ?´ì„œ ?¸íŒ…?©ë‹ˆ??
public class InGameUI : MonoBehaviour, IBegin
{
    ...
    void Start()
    {
        ...
        //    () => { Debug.Log("InGameUI.CloseAction ì°??«ê¸° - makeshiftCraftUI"); makeshiftCraftUI.SetActive(false); });
        UseTab();
    ...
    void Update()
    {
        ...
        {
            Debug.Log($"InGameUI - makeshiftCraftUI ?íƒœ : {makeshiftCraftUI.activeInHierarchy}");
        }
    ...
    public void ShowDefaultCraftUI()
    {
        ...
        OpenUI(new List<GameObject>() { defaultCraftUI }, ID_CRAFTTABLE,
            () =>
            {
                Debug.Log("InGameUI.CloseAction ì°??«ê¸° - defaultCraftUI");
    ...
    public void CloseDefaultCraftUI()
    {
        ...
        //    () =>
        //    {
        //        Debug.Log("InGameUI.CloseAction ì°??«ê¸° - makeshiftCraftUI");
        //        CommonUI.instance.CloseTab(makeshiftCraft.ui);
    ...
    public void UseTab()
    {
        ...
        {
            Debug.Log(">> InGameUI.UseTab() ?´ê¸°");

            OpenUI(new List<GameObject>() { gameObjectPlayerStatUiParent }, ID_CHAR_PANNEL,
                () => {
                    Debug.Log("InGameUI.CloseAction ì°??«ê¸° - gameObjectPlayerStatUiParent");
                    gameObjectPlayerStatUiParent.SetActive(false); }
                );
            OpenUI(new List<GameObject>() { makeshiftCraftUI }, ID_MAKESHIFT,
                () => {
                    ...
                    Debug.Log($"InGameUI.CloseAction ì°??«ê¸° - makeshiftCraftUI ?íƒœ : {makeshiftCraftUI.activeInHierarchy}");
                }
                );
    ...
    public void OpenUI(List<GameObject> uiGameobjects, int id)
    {
        OpenUI(uiGameobjects, id,
            () =>
            {
                Debug.Log("InGameUI.CloseAction ì°??«ê¸°");
